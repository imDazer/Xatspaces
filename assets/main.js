...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container02', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, replay: false });
		onvisible.add('#container01', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, replay: false });
		onvisible.add('#container03', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image01', { style: 'blur-in', speed: 2250, intensity: 6, delay: 125, replay: false });
